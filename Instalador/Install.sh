...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/Igmam21/HostPa/main/Instalador/install.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
